  ...
  <div class="flex">
    ...
    <wm-dialog title="添加" width="540px" :show="add.show" @update:close="add.show=$event">
      <wm-form class="form">
        ...
        <wm-form-item label="控制器">
          <wm-input v-model:value="add.form.controller" maxlength="20" placeholder="例如: /admin/sys_menus" />
        </wm-form-item>
    ...
    <wm-dialog title="编辑" width="540px" :show="edit.show" @update:close="edit.show=$event">
      <wm-form class="form">
        ...
        <wm-form-item label="控制器">
          <wm-input v-model:value="edit.form.controller" maxlength="20" placeholder="例如: /admin/sys_menus" />
        </wm-form-item>
        <wm-form-item label="URL">
...
.menus_icon{width: 32px; height: 32px; text-align: center; background-color: #FFF; border-radius: 50%;}
.menus_icon i{position: absolute; font-size: 20px; color: @Primary; transform: translate(-50%, 0);}
</style>
