...
.wm-popover .tip{position: absolute; padding: 8px 16px; line-height: 24px; border-radius: 4px; box-shadow: 0 2px 12px rgba(0,0,0,.1);}
...
.wm-popover_top .tip{bottom: 15px; transform: translate(-50%,0);}
.wm-popover_top .arrow{position: absolute; top: -16px; left: -8px; width: 0px; height: 0px; border: 8px solid; border-color: transparent;}
...
.wm-popover_bottom .tip{top: 15px; transform: translate(-50%,0);}
.wm-popover_bottom .arrow{position: absolute; top: 0; left: -8px; width: 0px; height: 0px; border: 8px solid; border-color: transparent;}
...
.wm-popover_left .tip{left: -15px; transform: translate(-100%,-50%);}
.wm-popover_left .arrow{position: absolute; left: -16px; top: -8px; width: 0px; height: 0px; border: 8px solid; border-color: transparent;}
...
.wm-popover_right .tip{right: -15px; transform: translate(100%,-50%);}
.wm-popover_right .arrow{position: absolute; right: -16px; top: -8px; width: 0px; height: 0px; border: 8px solid; border-color: transparent;}
