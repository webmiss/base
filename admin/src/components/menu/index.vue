      ...
      <template v-if="v1.children">
        <div :id="'list_'+k1" class="wm-menu_list">
          <div v-for="(v2,k2) in v1.children" :key="k2">
            <!-- 标题 -->
            <div @click="_titleClick([k1,k2])" class="wm-menu_title left20" :class="!v2.children&&active==k1+'_'+k2?'active':''" :style="{height: height+'px', lineHeight: height+'px'}">
            ...
            <template v-if="v2.children">
              <div :id="'list_'+k1+'_'+k2" class="wm-menu_list">
                <div v-for="(v3,k3) in v2.children" :key="k3">
                  <!-- 标题 -->
                  <div @click="_titleClick([k1,k2,k3])" class="wm-menu_title left30" :class="!v3.children&&active==k1+'_'+k2+'_'+k3?'active':''" :style="{height: height+'px', lineHeight: height+'px'}">
...
.wm-menu .left10{padding-left: 10px;}
.wm-menu .left20{padding-left: 20px;}
.wm-menu .left30{padding-left: 30px;}
.wm-menu .left40{padding-left: 40px;}
...
.wm-menu_title h2{float: left; font-size: 14px; font-weight: normal;}
