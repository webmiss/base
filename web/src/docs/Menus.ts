...
export default {
  ...
  vue(){
    return [
      ...
      {label:'Admin Component', children:[
        {label: 'Menu 导航菜单', value: 'docs/vue/component/menu'},
        {label: 'Action 动作菜单', value: 'docs/vue/component/action'},
        {label: 'Dialog 对话框', value: 'docs/vue/component/dialog'},
        {label: 'Form 表单', value: 'docs/vue/component/form'},
        {label: 'Img 图片', value: 'docs/vue/component/img'},
        {label: 'Loading 动画', value: 'docs/vue/component/loading'},
        {label: 'Main 布局', value: 'docs/vue/component/main'},
        {label: 'Page 分页', value: 'docs/vue/component/page'},
        {label: 'Popover 弹出框', value: 'docs/vue/component/popover'},
        {label: 'Popup 弹出层', value: 'docs/vue/component/popup'},
        {label: 'ScrollView 滑动层', value: 'docs/vue/component/scrollview'},
        {label: 'Switch 开关', value: 'docs/vue/component/switch'},
        {label: 'Table 表格', value: 'docs/vue/component/table'},
        {label: 'Tag 标签', value: 'docs/vue/component/tag'},
        {label: 'TinyMCE 编辑器', value: 'docs/vue/component/tinymce'},
        {label: 'Tree 树形控件', value: 'docs/vue/component/tree'},
        {label: 'Uploader 上传', value: 'docs/vue/component/uploader'},
      ]},
      {label:'Library Ui', children:[
        {label: 'Request 请求', value: 'docs/vue/ui/request'},
        {label: 'Storage 本地硬盘', value: 'docs/vue/ui/storage'},
        {label: 'Back 返回', value: 'docs/vue/ui/ui-back'},
        {label: 'Loading 加载', value: 'docs/vue/ui/ui-loading'},
        {label: 'NavigateTo 跳转', value: 'docs/vue/ui/ui-navigate-to'},
        {label: 'Toast 提示', value: 'docs/vue/ui/ui-toast'},
      ]},
      {label:'Library Plus', children:[
      ...
      {label:'Library Inc', children:[
        {label: 'DownBlob 二进制下载', value: 'docs/vue/inc/down-blob'},
        {label: 'DownFile 文件下载', value: 'docs/vue/inc/down-file'},
        {label: 'HtmlLoad 加载Css和JS', value: 'docs/vue/inc/html-load'},
        {label: 'HtmlObserve 监听容器', value: 'docs/vue/inc/html-observe'},
        {label: 'Reg 正则验证', value: 'docs/vue/inc/reg'},
        {label: 'TimeDay 获取日期', value: 'docs/vue/inc/time-day'},
        {label: 'URL 编码&解码', value: 'docs/vue/inc/url'},
        {label: 'VersionDiff 版本比较', value: 'docs/vue/inc/version-diff'},
      ]},
    ];
  },
