...
.map_marker{width: 64px; height: 62px; padding-top: 2px; background: url(https://webmis.vip/map/img/map_marker.svg) no-repeat center center; background-size: auto 100%;}
.map_marker_img{width: 48px; height: 48px; margin: 0 auto; background-color: #FFF; border-radius: 50%; background-repeat: no-repeat; background-position: center center; background-size: 100%;}
.map_tool{cursor: pointer; position: absolute; z-index: 99; right: 10px; bottom: 10px; width: 40px; height: 40px; background-color: #FFF; border-radius: 50%; box-shadow: 0 0 10px rgba(0,0,0,0.1); background-repeat: no-repeat; background-position: center center; background-size: 60%;}
